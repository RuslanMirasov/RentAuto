export const cars = [
  ...
  },
  {
    ...
    accessories: ['Nappa leather seats', 'Bowers & Wilkins premium sound system', 'Head-up display'],
    functionalities: ['IntelliSafe advanced safety features', 'Pilot Assist semi-autonomous driving', 'Four-zone automatic climate control'],
    rentalPrice: '$50',
  ...
  },
  {
    ...
    fuelConsumption: '7.9',
    engineSize: '2.0L 4-cylinder',
    accessories: ['Premium leather seats', 'Harman Kardon audio system', 'Hands-free power tailgate'],
    functionalities: [
  ...
  },
  {
    ...
    functionalities: ['Electronic locking front and rear differentials', 'Stabilitrak stability control', 'Tire pressure monitoring system'],
    rentalPrice: '$55',
  ...
  },
  {
    ...
    accessories: ['Leather upholstery', 'Power moonroof', 'Harman Kardon premium audio system'],
    functionalities: ['Symmetrical All-Wheel Drive', 'X-Mode off-road assist', 'Subaru EyeSight driver-assist system'],
    rentalPrice: '$35',
    rentalCompany: 'Adventure Car Rentals',
  ...
  },
  {
    ...
    accessories: ['Heated front seats', 'Rockford Fosgate premium audio system', 'Power liftgate'],
    functionalities: ['Super All-Wheel Control', 'Multi-View camera system', 'Bluetooth hands-free system'],
    rentalPrice: '$30',
  ...
  },
  {
    ...
    fuelConsumption: '9.5',
    engineSize: '3.5L V6',
    accessories: ['Tri-Zone Automatic Climate Control', 'Bose premium audio system', 'Rear-seat entertainment system'],
    functionalities: ['Intelligent 4x4 system', 'Advanced Drive-Assist Display', 'Nissan Intelligent Key with push-button ignition'],
    rentalPrice: '$40',
    rentalCompany: 'Luxury Car Rentals',
  ...
  },
  {
    ...
    engineSize: '5.4L V8',
    accessories: ['Premium leather seats', 'THX II Certified audio system', 'Power-deployable running boards'],
    functionalities: ['AdvanceTrac with Roll Stability Control', 'Voice-Activated Navigation System', 'Power liftgate'],
    rentalPrice: '$50',
  ...
  },
  {
    ...
    engineSize: '6.0L V8',
    accessories: ['Heated and ventilated front seats', 'BOSE premium sound system', 'Power-folding third-row seats'],
  ...
  },
  {
    ...
    fuelConsumption: '8.2',
    engineSize: '2.0L 4-cylinder',
    accessories: ['Apple CarPlay and Android Auto integration', 'Blind Spot Detection', 'Hands-free smart liftgate'],
  ...
  },
  {
    ...
    accessories: ['Convertible soft top', 'Sport seats', 'MINI Connected infotainment system'],
    functionalities: ['Front-Wheel Drive', 'Dynamic Stability Control', 'Rain-sensing wipers'],
    rentalPrice: '$30',
  ...
  },
  {
    ...
    engineSize: '6.8L V8',
    accessories: ['Mulliner Driving Specification', 'Naim for Bentley premium audio system', 'Heated steering wheel'],
  ...
  },
  {
    ...
    engineSize: '5.0L V8',
    accessories: ['Airscarf neck-level heating', 'Harman Kardon premium audio system', 'Active Body Control suspension'],
  ...
  },
  {
    ...
    engineSize: '6.0L V12',
    accessories: ['Carbon Ceramic brakes', 'Bang & Olufsen BeoSound audio system', 'Bridge of Weir leather upholstery'],
    functionalities: ['Rear-Wheel Drive', 'Carbon-fiber body panels', 'Adaptive Damping System'],
    rentalPrice: '$200',
  ...
  },
  {
    ...
    functionalities: ['Rear-Wheel Drive', 'Limited-slip differential', 'High-performance exhaust'],
    rentalPrice: '$50',
  ...
  },
  {
    ...
    engineSize: '6.5L V12',
    accessories: ['Carbon-fiber body panels', 'Alcantara upholstery', 'Lamborghini Infotainment System'],
    functionalities: ['All-Wheel Drive', 'Electronic Stability Control', 'Retractable soft-top roof'],
    rentalPrice: '$500',
  ...
  },
  {
    ...
    accessories: ['Bang & Olufsen 3D sound system', 'Audi Virtual Cockpit', 'Audi Drive Select'],
    functionalities: ['Front-Wheel Drive', 'Quattro all-wheel drive available', 'Power-folding acoustic soft-top'],
    rentalPrice: '$150',
    rentalCompany: 'Luxury Car Rentals',
  ...
  },
  {
    ...
    engineSize: '4.9L V8',
    accessories: ['Aluminum space frame', 'Nappa leather upholstery', 'Harman Kardon audio system'],
    functionalities: ['Rear-Wheel Drive', 'Dynamic Stability Control', 'Power-operated soft-top roof'],
    rentalPrice: '$300',
    rentalCompany: 'Classic Car Rentals',
  ...
  },
  {
    ...
    engineSize: '5.7L V8',
    accessories: ['Leather upholstery', 'Bose premium sound system', 'Performance suspension'],
    functionalities: ['Rear-Wheel Drive', 'Limited-slip differential', 'Power-operated convertible top'],
    rentalPrice: '$200',
  ...
  },
  {
    ...
    fuelConsumption: '9.8',
    engineSize: '3.5L V6',
    accessories: ['Airscarf neck-level heating', 'Harman Kardon surround sound system', 'Magic Sky Control panoramic roof'],
    functionalities: ['Rear-Wheel Drive', 'Dynamic Stability Control', 'Retractable hardtop roof'],
    rentalPrice: '$250',
    rentalCompany: 'Luxury Car Rentals',
  ...
  },
  {
    ...
    model: 'Voyager',
    type: 'Van/Minivan',
    img: 'https://autorevue.at/files/uploads/2023/11/chrysler-voyager-13.jpg',
    description:
    ...
    fuelConsumption: '8.2',
    engineSize: '3.6L V6',
    accessories: ["Stow 'n Go seating", 'Uconnect infotainment system', 'Blind Spot Monitoring'],
    functionalities: ['Front-Wheel Drive', 'Electronic Stability Control', 'Power sliding side doors'],
    rentalPrice: '$100',
  ...
  },
  {
    ...
    fuelConsumption: '6.2',
    engineSize: '1.6L 4-cylinder',
    accessories: ['Apple CarPlay and Android Auto integration', 'Smart Key with Push Button Start', 'Automatic climate control'],
  ...
  },
  {
    ...
    fuelConsumption: '8.5',
    engineSize: '2.0L 4-cylinder',
    accessories: ['Leather upholstery', 'Panoramic sunroof', 'Harman Kardon premium sound system'],
    functionalities: ['All-Wheel Drive', 'City Safety collision avoidance technology', 'Power tailgate'],
    rentalPrice: '$150',
    rentalCompany: 'Premium Car Rentals',
  ...
  },
  {
    ...
    fuelConsumption: '11.8',
    engineSize: '3.0L V6',
    accessories: ['Premium Windsor leather seats', 'Meridian surround sound system', 'Adaptive Dynamics suspension'],
    functionalities: ['All-Wheel Drive', 'Terrain Response 2 system', 'Power-operated gesture tailgate'],
    rentalPrice: '$300',
  ...
  },
  {
    ...
    model: 'X6M',
    type: 'SUV',
    img: 'https://autotrends.org/wp-content/uploads/2020-BMW-X6-M-Competition-review.jpg',
    description:
      'BMW X6 in 2021 belonged to the 3rd generation, produced in the body: jeep/suv 5-door. The car was equipped with 3.0, 4.4 litres engines. In 2021 BMW X6 was left without restyling.',
    fuelConsumption: '4.4',
    engineSize: '1.6L 4-cylinder',
    accessories: ['Apple CarPlay and Android Auto integration', 'Smart Key with Push Button Start', 'Automatic climate control'],
    functionalities: ['Front-Wheel Drive', 'Electronic Stability Control', 'Rearview camera'],
    rentalPrice: '$80',
    rentalCompany: 'Economy Car Rentals',
    address: '321 Example Lane, Mariupol, Ukraine',
    rentalConditions: "Minimum age: 21\nValid driver's license\nSecurity deposit and insurance required",
    mileage: 6234,
  },
];
